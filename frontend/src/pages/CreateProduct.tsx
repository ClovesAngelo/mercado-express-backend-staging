                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        Número de unidades disponíveis ao criar o produto
                      </p>
                    </div>
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-gray-500 mt-1">
                        Você receberá uma notificação quando o estoque chegar a esta quantidade
                      </p>
                    </div>
                  </div>
                </div>
              ...
              {(formData.name || formData.price || formData.categoryId) && (
                <div className="bg-white shadow-md rounded-lg p-6">
                  ...
                  <div className="space-y-2 text-sm">
                    ...
                    {formData.minStock && (
                      <div className="flex justify-between">
                        <span className="text-gray-600">Alerta de estoque:</span>
                        <span className="font-medium text-gray-900">{formData.minStock} unidades</span>
                      </div>
                    )}
                  </div>
                </div>
